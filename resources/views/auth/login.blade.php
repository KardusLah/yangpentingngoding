...
<head>
  ...
  <link rel="stylesheet" crossorigin href="{{asset("be/assets/compiled/css/app.css")}}">
  <link rel="stylesheet" crossorigin href="{{asset("be/assets/compiled/css/app-dark.css")}}">
  <link rel="stylesheet" crossorigin href="{{asset("be/assets/compiled/css/auth.css")}}">
</head>

<body>
    <script src="{{asset("be/assets/static/js/initTheme.js")}}"></script>
    <div id="auth">
        ...
        <div id="auth-left">
            ...
            <form action="{{route('login-user')}}" method="POST" class="login-form">
                ...
                <div class="form-group position-relative has-icon-left mb-4">
                    <input type="email" class="form-control form-control-xl" placeholder="Email" id="email" class="input-field" name="email" value="{{ old('email') }}">
                    <div class="form-control-icon">
                        <i class="bi bi-envelope"></i>
                    </div>
                </div>
                <div class="form-group position-relative has-icon-left mb-4">
                    <input type="password" class="form-control form-control-xl" placeholder="Password" id="password" class="input-field" name="password">
                    <div class="form-control-icon">
