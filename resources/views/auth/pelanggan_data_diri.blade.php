...
<head>
    ...
    <title>Lengkapi Data Diri - Pelanggan</title>
        ...
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    ...
                    <h1 class="auth-title">Lengkapi Data Diri</h1>
                    <p class="auth-subtitle mb-5">Isi data diri Anda sebagai pelanggan.</p>
                    <form action="{{ route('auth.pelangganDataDiriSimpan') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @if ($errors->any())
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="text" class="form-control form-control-xl" name="nama_lengkap" placeholder="Nama Lengkap" required>
                            <div class="form-control-icon">
                                <i class="bi bi-person"></i>
                            </div>
                        </div>
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="text" class="form-control form-control-xl" name="alamat" placeholder="Alamat" required>
                            <div class="form-control-icon">
                                <i class="bi bi-geo-alt"></i>
                            </div>
                        </div>
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="file" class="form-control form-control-xl" name="foto" required>
                            <div class="form-control-icon">
