...
<head>
    ...
    <title>Lupa Password - Mazer Admin Dashboard</title>
                ...
                <div id="auth-left">
                    ...
                    <form method="POST" action="{{ route('password.email') }}">
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="email" class="form-control form-control-xl" name="email" placeholder="Email" required value="{{ old('email') }}">
                            <div class="form-control-icon">
                                <i class="bi bi-envelope"></i>
                            </div>
                            @error('email') <div class="text-danger">{{ $message }}</div> @enderror
                        </div>
                        <button class="btn btn-primary btn-block btn-lg shadow-lg mt-3" type="submit">Kirim Link Reset</button>
                    </form>
                    <div class="text-center mt-4 text-lg fs-4">
                        <p><a href="{{ route('login') }}" class="font-bold">Kembali ke Login</a></p>
                    </div>
                </div>
            </div>
