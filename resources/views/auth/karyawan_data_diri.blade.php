...
<head>
    ...
    <title>Lengkapi Data Karyawan</title>
        ...
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    ...
                    <h1 class="auth-title">Lengkapi Data Karyawan</h1>
                    <p class="auth-subtitle mb-5">Isi data karyawan sesuai identitas.</p>
                    <form action="{{ route('auth.karyawanDataDiriSimpan') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @if ($errors->any())
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="text" class="form-control form-control-xl" name="nama_karyawan" placeholder="Nama Karyawan" required>
