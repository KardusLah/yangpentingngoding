...
<head>
  ...
  <link rel="stylesheet" crossorigin href="{{ asset('be/assets/compiled/css/iconly.css') }}">
</head>
...
@yield('footer')
    ...
    <script src="{{ asset('be/assets/static/js/components/dark.js') }}"></script>
    <script src="{{ asset('be/assets/extensions/perfect-scrollbar/perfect-scrollbar.min.js') }}"></script>
    
    
    <script src="{{ asset('be/assets/compiled/js/app.js') }}"></script>
